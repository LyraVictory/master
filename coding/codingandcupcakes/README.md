...
4.  In the Codeanywhere editor, select **File** -> **New Connection** -> **GitHub**.
5.  Click **Connect your GitHub account**, enter your GitHub account details, and click **Authorize application**. 
    *  You may need to disable your browser's pop-up blocker. To do so, click on the pop-up blocker icon at the far right of your browser's address bar and select "Always allow pop-ups from codeanywhere.com"
6.  Select your codingandcupcakes repository and click Next. 
    *  The application may take up to 45 seconds to copy the repository. When it's finished, you should see a list of files in the left sidebar of the editor screen. 
